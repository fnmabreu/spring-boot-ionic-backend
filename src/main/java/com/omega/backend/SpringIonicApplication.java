...
public class SpringIonicApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat5 = new Categoria(null, "Cinema");
		Categoria cat6 = new Categoria(null, "Jogos");
		Categoria cat7 = new Categoria(null, "Telemóveis");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "228374733", TipoCliente.PESSOAFISICA);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("21/03/2018 10:32"), cli1, e1);
