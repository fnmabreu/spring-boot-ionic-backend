package com.omega.backend.resources;
...
import com.omega.backend.dto.CategoriaDTO;
import com.omega.backend.services.CategoriaService;
...
public class CategoriaResource {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 400, message = "Não é possível eliminar uma categoria que possui produtos"),
