...
public class SwaggerConfig {
	...
	private final ResponseMessage m204del = simpleMessage(204, "Eliminação ok");
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.omega.backend.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Curso Spring Boot", "Udemy - Curso Spring Boot, Hibernate, REST, Ionic, JWT, S3, MySQL",
				"Versão 1.0", "https://www.udemy.com/terms",
				new Contact("Fabio Abreu", "https://github.com/fnmabreu/spring-ionic-backend", "fnmabreu@gmail.com"),
